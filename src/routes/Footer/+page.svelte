...
<section class="bg-secondary">
	<div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
					...
					<nav class="flex flex-wrap justify-start -mx-2 -my-1">
						<div class="px-6 py-1">
							<a
								...
								class="text-base font-joseph font-bold text-primary hover:text-primary-hover"
							>
								About
							</a>
						</div>
		...
		<div class="flex justify-center mt-8 space-x-2">
			<!-- linkein icon/URL -->
			<a
				href="https://www.linkedin.com/company/dunesaero/"
				target="_blank"
				class="text-gray-400 hover:text-gray-500 hover:opacity-70"
			>
			...
			<!-- twitter icon/URL -->
			<a href="#" target="_blank" class="text-gray-400 hover:text-gray-500 hover:opacity-70">
			...
			<!-- Email icon and URL -->
			<a href="#" class="text-gray-400 hover:text-gray-500 hover:opacity-70">
	...
	<p class="mt-8 text-base text-center text-secondary bg-primary">© 2023 - Dunes Aero.</p>
</section>
